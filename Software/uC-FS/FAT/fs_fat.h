...
#include  <fs_fat_type.h>                                       /* FAT Data Types.                                      */

#include  <fs_fat_file.h>                                       /* FAT File Access & Management.                        */
#include  <fs_fat_dir.h>                                        /* FAT Directory Access & Management.                   */

#include  <fs_fat_entry.h>                                      /* FAT File System Entry Access.                        */

#include  <fs_fat_sfn.h>                                        /* FAT Short File Name Access.                          */

#ifdef     FS_FAT_LFN_MODULE_PRESENT
#include  <fs_fat_lfn.h>                                        /* FAT Long  File Name Access.                          */
#endif

#ifdef     FS_FAT_FAT12_MODULE_PRESENT
#include  <fs_fat_fat12.h>                                      /* FAT12 File System Access.                            */
#endif
#ifdef     FS_FAT_FAT16_MODULE_PRESENT
#include  <fs_fat_fat16.h>                                      /* FAT16 File System Access.                            */
#endif
#ifdef     FS_FAT_FAT32_MODULE_PRESENT
#include  <fs_fat_fat32.h>                                      /* FAT32 File System Access.                            */
#endif

#ifdef     FS_FAT_JOURNAL_MODULE_PRESENT
#include  <fs_fat_journal.h>                                    /* Journaling.                                          */
#endif
...
#define  FS_FAT_BS_FAT12_OFF_DRVNUM                       36u
#define  FS_FAT_BS_FAT12_OFF_RESERVED1                    37u
#define  FS_FAT_BS_FAT12_OFF_BOOTSIG                      38u
#define  FS_FAT_BS_FAT12_OFF_VOLID                        39u
#define  FS_FAT_BS_FAT12_OFF_VOLLAB                       43u
#define  FS_FAT_BS_FAT12_OFF_FILSYSTYPE                   54u

#define  FS_FAT_BS_FAT16_OFF_DRVNUM                       36u
#define  FS_FAT_BS_FAT16_OFF_RESERVED1                    37u
#define  FS_FAT_BS_FAT16_OFF_BOOTSIG                      38u
#define  FS_FAT_BS_FAT16_OFF_VOLID                        39u
#define  FS_FAT_BS_FAT16_OFF_VOLLAB                       43u
#define  FS_FAT_BS_FAT16_OFF_FILSYSTYPE                   54u
...
struct  fs_fat_data {
    FS_TYPE                   Type;                             /* Type cfg'd @ init : FS_FAT_TYPE_FAT_INFO.            */
...
#ifdef  FS_FAT_JOURNAL_MODULE_PRESENT
    CPU_BOOLEAN               JournalOpen;
    CPU_BOOLEAN               JournalStart;
    CPU_BOOLEAN               JournalReplay;
    CPU_BOOLEAN               JournalReplayBlk;
    CPU_BOOLEAN               JournalFileWr;
    FS_FAT_FILE_DATA         *JournalDataPtr;
    FS_BUF                   *JournalBufPtr;
    FS_FAT_FILE_SIZE          JournalBufPosHi;
    FS_FAT_FILE_SIZE          JournalFilePosHi;
#endif
