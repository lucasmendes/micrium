...
#define  FS_FILE_ACCESS_MODE_CACHED              DEF_BIT_06
...
*                                          FILE TYPE DEFINES
*
* Note(s) : (1) FS_FILE_TYPE_??? #define values specifically chosen as ASCII representations of the file
*               types.  Memory displays of file types will display the file TYPE with the chosen ASCII
*               name.
*********************************************************************************************************
*/

#define  FS_FILE_TYPE_NONE          FS_TYPE_CREATE(ASCII_CHAR_LATIN_UPPER_N,  \
                                                   ASCII_CHAR_LATIN_UPPER_O,  \
                                                   ASCII_CHAR_LATIN_UPPER_N,  \
                                                   ASCII_CHAR_LATIN_UPPER_E)

#define  FS_FILE_TYPE_FILE          FS_TYPE_CREATE(ASCII_CHAR_LATIN_UPPER_F,  \
...
*                                           FILE DATA TYPE
*
* Note(s) : (1) Forced word-alignment at start of file NOT required since first data member 'Type'
*               is declared as 'CPU_INT32U'.
*
*           (2) 'DataPtr' can be assigned pointer to file system driver-specific datum/struct/buffer.
*********************************************************************************************************
*/

struct  fs_file {
    FS_TYPE         Type;                                       /* Type cfg'd @ init : FS_FILE_TYPE_FILE.               */
