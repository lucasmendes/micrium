...
*                                         VOLUME TYPE DEFINES
*
* Note(s) : (1) FS_VOL_TYPE_??? #define values specifically chosen as ASCII representations of the volume
*               types.  Memory displays of volume types will display the volume TYPE with the chosen ASCII
*               name.
*********************************************************************************************************
*/

#define  FS_VOL_TYPE_NONE           FS_TYPE_CREATE(ASCII_CHAR_LATIN_UPPER_N,  \
                                                   ASCII_CHAR_LATIN_UPPER_O,  \
                                                   ASCII_CHAR_LATIN_UPPER_N,  \
                                                   ASCII_CHAR_LATIN_UPPER_E)

#define  FS_VOL_TYPE_VOL            FS_TYPE_CREATE(ASCII_CHAR_LATIN_UPPER_V,  \
                                                   ASCII_CHAR_LATIN_UPPER_O,  \
...
*                                          VOLUME DATA TYPE
*
* Note(s) : (1) Forced word-alignment at start of volume NOT required since first data member 'Type'
*               is declared as 'CPU_INT32U'.
*********************************************************************************************************
*/

struct  fs_vol {
    FS_TYPE            Type;                                    /* Type cfg'd @ init : FS_VOL_TYPE_VOL.                 */
