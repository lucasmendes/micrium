...
extern  const  NET_DEV_CFG_ETHER  NetDev_Cfg_A_1;       /*   Example Ethernet     configuration for device A, #1        */
extern  const  NET_PHY_CFG_ETHER  NetPhy_Cfg_A_1;       /*   Example Ethernet Phy configuration for device A, #1        */

extern  const  NET_DEV_CFG_ETHER  NetDev_Cfg_A_2;       /*   Example Ethernet     configuration for device A, #2        */
extern  const  NET_PHY_CFG_ETHER  NetPhy_Cfg_A_2;       /*   Example Ethernet Phy configuration for device A, #2        */
